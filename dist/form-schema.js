...
var FormSchema = /*#__PURE__*/function (_FormFieldSchema) {
  ...
  _proto.setupColumns = function setupColumns() {
    ...
    if (this.hasRecordSeriesID) {
      var expr1 = (0, _helpers.AExpr)(0, '=', (0, _helpers.ColumnRef)('_record_series_id', 'records'), (0, _helpers.ColumnRef)('record_series_id', 'record_series'));
      var expr2 = (0, _helpers.BooleanTest)((0, _helpers.ColumnRef)('enabled', 'record_series'), 0);
      this.recordSeriesColumn = this.addSystemColumn('Record Series', 'recordSeries', 'record_series.rrule', 'string', null, {
        ...
        alias: 'record_series',
        ast: (0, _helpers.BoolExpr)(0, [expr1, expr2])
      });
    }
    ;
    if (this.fullSchema) {
