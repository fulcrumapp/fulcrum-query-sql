  ...
  _proto.targetList = function targetList() {
    ...
    if (this.schema.recordSeriesColumn) {
      ...
      if (subJoinColumns.indexOf(this.schema.recordSeriesColumn) === -1) {
        joinedColumns.push((0, _helpers.ResTarget)((0, _helpers.ColumnRef)('record_series_id', _alias2), _alias2));
      } else {
        joinedColumns.push((0, _helpers.ResTarget)((0, _helpers.ColumnRef)(_alias2 + ".record_series_id"), _alias2));
      }
    }
