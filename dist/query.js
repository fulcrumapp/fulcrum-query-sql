...
var Query = /*#__PURE__*/function () {
  ...
  _proto.clearAllFilters = function clearAllFilters() {
    ...
    this._sorting = new _sortExpressions["default"](null, this._schema);
  ...
  _proto.targetList = function targetList() {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(this.schema._rawColumns), _step; !(_step = _iterator()).done;) {
    ...
    if (this.schema.recordSeriesColumn) {
      ...
      if (subJoinColumns.indexOf(this.schema.recordSeriesColumn) === -1) {
        joinedColumns.push((0, _helpers.ResTarget)((0, _helpers.ColumnRef)('record_series_id', _alias2), 'record_series_id'));
        joinedColumns.push((0, _helpers.ResTarget)((0, _helpers.ColumnRef)('rrule', _alias2), 'rrule'));
      } else {
        joinedColumns.push((0, _helpers.ResTarget)((0, _helpers.ColumnRef)(_alias2 + '.record_series_id'), 'record_series_id'));
  ...
  _proto.toHumanDescription = function toHumanDescription() {
    ...
    if (description = this.columnSettings.columns.map(function (o) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(description), _step2; !(_step2 = _iterator2()).done;) {
