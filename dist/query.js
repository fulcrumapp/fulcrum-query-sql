...
function () {
  ...
  _proto.targetList = function targetList() {
    ...
    var subJoinColumns = this.joinColumnsWithSorting; // for (const column of this.schema._rawColumns) {
