...
var Converter = /*#__PURE__*/function () {
  function Converter() {
    ...
    _defineProperty(this, "ArrayIsContainedIn", function (expression) {
      var values = (0, _helpers.AArrayExpr)(expression.arrayValue.map(function (v) {
        return _this.ConstValue(expression.column, v);
      }));
      return (0, _helpers.AExpr)(0, '<@', columnRef(expression.column), values);
  ...
  _proto.targetList = function targetList(query, sort, boundingBox) {
    ...
    if (subJoinColumns.indexOf(query.schema.recordSeriesColumn) !== -1) {
      ...
      list.push((0, _helpers.ResTarget)((0, _helpers.ColumnRef)('enabled', query.schema.recordSeriesColumn.join.alias), query.schema.recordSeriesColumn.id));
    }
  ...
  Converter.joinClause = function joinClause(baseQuery, _ref7) {
    var inner = _ref7.inner,
      ...
      rarg = _ref7.rarg,
      ast = _ref7.ast;
    return (0, _helpers.JoinExpr)(inner ? 0 : 1, baseQuery, rarg || (0, _helpers.RangeVar)(tableName, (0, _helpers.Alias)(alias)), ast ? ast : (0, _helpers.AExpr)(0, '=', (0, _helpers.ColumnRef)(sourceColumn, sourceTableName || 'records'), (0, _helpers.ColumnRef)(joinColumn, alias)));
  };
